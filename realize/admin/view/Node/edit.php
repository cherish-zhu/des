            ...
            <div class="col-lg-6" style="width:100% !important">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" action="/admin/Node/edit?id=<?php echo $_GET['id']?>" method="post" id="commentForm">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">节点名称：</label>
                                        <div class="col-sm-8">
                                            <input id="name" name="title" minlength="2" type="text" class="form-control" value="<?php echo $x['title']?>" required aria-required="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Controller：</label>
                                        <div class="col-sm-8">
                                            <input id="alias" type="text" class="form-control" name="controller"  value="<?php echo $x['controller']?>"  required aria-required="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Action：</label>
                                        <div class="col-sm-8">
                                            <input id="description" type="text" class="form-control" name="action" value="<?php echo $x['action']?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">别名：</label>
                                        <div class="col-sm-8">
                                            <input id="keyword" type="text" class="form-control" name="name" value="<?php echo $x['name']?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
