                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo ($artist); ?></h1>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo ($fans); ?></h1>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo ($new); ?></h1>
                                <div class="stat-percent font-bold text-navy"><?php echo ($new/$fans); ?>% <i class="fa fa-level-up"></i>
                                </div>
                                <small>本周注册用户数</small>
                            </div>
                        </div>
