...
body{ font-family: '微软雅黑'; text-align:center; color:#000; font-size: 16px;padding: 0px; margin: 0px auto; }

.system-message{text-align:left; margin-top:230px; border:1px #999 solid; width:420px; padding:50px; background-color:#CCC}
...
h1, .success{float:left;}
.system-message .success,.system-message .error{ line-height: 1.8em; font-size: 36px }
.success{ height:120px; line-height:120px !important; text-indent:10px;margin-bottom: 12px}
