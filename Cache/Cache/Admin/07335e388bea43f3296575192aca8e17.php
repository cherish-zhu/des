<?php if (!defined('THINK_PATH')) exit();?><form name="form1" method="post" action="/admin/album/edit_pic?id=<?php echo $val['id']?>"><table width="650" height="133" border="0" cellpadding="0" cellspacing="0">
  <tr>
